...
By default the generated arguments consist of the specified lower bound, upper bound, and all powers of eight between them. In the example above the arguments generated are [ 8, 64, 512, 4k, 8k ]. In the following code the
